...
| OS-08 | 경기 요약 지표 줄과 슈팅 타임라인 | 완료 | (OS-08 커밋) | 흐름 탭 맨 위: 평균 평점·득점·도움·점유율·슈팅 정확도·패스 정확도 타일, 찬 슛/허용한 슛 두 줄 타임라인(45 = 전반 추가시간까지, 90+ = 후반 추가시간·연장). 화면 확인함 |
| OS-09 | 시간대 그래프 | 대기 | | |
