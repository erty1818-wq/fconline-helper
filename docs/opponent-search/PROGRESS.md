...
- 작업: OS-11 나 vs 상대 비교 (비교 탭)
- 담당: Claude (2026-09-26)
- 시작한 것: `Services/Profile.cs`(점유율, 경기당 슈팅·유효, 슈팅 정확도, 패스·태클 성공률, 가로채기, 평균 득실). 내 쪽은 DB에 동기화된 내 공식경기 최근 30개. 비교 탭 틀(`SearchWindow.Compare.cs`)은 OS-12~16이 같이 쓴다.
